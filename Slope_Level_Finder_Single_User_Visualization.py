...
##    results_which_satisfy_the_least_conditions = [result for result in list_results if result[0] == 0 and result[1] > 0.05]
    ...
    results_which_satisfy_the_least_conditions = [result for result in list_results if result[0] == 0 and result[1] > 0.05 and result[3] < 3000]
...
##    print ('df_post : ', df_post)
    ...
    j = 0
    Levels_Slopes = [] # ['A1Q','A2Q','A3Q','A4Q','B1Q','B2Q','B3Q','B4Q','C1Q','C2Q','C3Q','C4Q'] ==> A1Q = Level at start of pre interval for Quote tweets, A2Q = Leve at end of pre interval for Quote tweets  A3Q = Slope of pre interval for Quote tweets, A4Q = Significance Status of pre interval for Quote tweets , B and C also have the same structure like A but for within interval and post interval of Quote tweets respectively
    # A4Q or B4Q or C4Q are coded like this:
...
##        print (Dataframe_Slices_Names[j])
        if dfs.shape[0] > 0 and ((dfs[tweet_type] != 0).sum() > 3): # At least 3 non zero values must be exist (ie at least 3 days with tweet published in the corrosponding type
...
def main():
    ...
    i = 0
    Columns_List = ['A1Q','A2Q','A3Q','A4Q','B1Q','B2Q','B3Q','B4Q','C1Q','C2Q','C3Q','C4Q']
...
##    j = 25213
    ...
    Levels_Slopes = slope_level_finder (df_pre, df_within, df_post, 'retweet')
    print (Levels_Slopes)
